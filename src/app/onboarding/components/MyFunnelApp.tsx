...
import { JobCategoryFunnel } from "./JobCategoryFunnel";
import { JobFunnel } from "./JobFunnel";
import { ExperienceFunnel } from "./ExperienceFunnel";
import { EducationFunnel } from "./EducationFunnel";
import { LocationFunnel } from "./LocationFunnel";
import type {
  직군입력,
  직무입력,
  경력입력,
...
export default function MyFunnelApp() {
    ...
    <funnel.Render
      ...
      직무입력={({ context, history }) => (
        <JobFunnel
          jobGroup={context.직군}
          onBack={() => history.back()}
          onNext={(직무) => history.push("경력입력", { ...context, 직무 })}
        />
      )}
